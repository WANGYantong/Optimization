function [x,endPop,bPop,traceInfo] = GO_ga(bounds,evalFN,evalOps,startPop,opts,...
termFN,termOps,selectFN,selectOps,xOverFNs,xOverOps,mutFNs,mutOps)
% GAOT_GA run a genetic algorithm
% function [x,endPop,bPop,traceInfo]=gaot_ga(bounds,evalFN,evalOps,startPop,opts,
